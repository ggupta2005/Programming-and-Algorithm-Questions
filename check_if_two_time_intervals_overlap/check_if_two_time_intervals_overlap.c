 ...
 */
bool check_if_time_intervals_overlap_v1 (int s1, int e1, int s2, int e2)
{
    /*
 ...
 * themselves incorrect, then this function returns 'false'.
 */
bool check_if_time_intervals_overlap_v2 (int s1, int e1, int s2, int e2)
{
    /*
     * If either of the time intervals is incorrect, that is the
     * start time is greater than the end time, then return 'false'
...
int main ()
{
    ...
    assert(false == check_if_time_intervals_overlap_v1(s12, e12, s22, e22));
    assert(false == check_if_time_intervals_overlap_v1(s22, e22, s12, e12));
    assert(false == check_if_time_intervals_overlap_v2(s12, e12, s22, e22));
    assert(false == check_if_time_intervals_overlap_v2(s22, e22, s12, e12));
