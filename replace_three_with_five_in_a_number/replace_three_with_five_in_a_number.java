...
public class replace_three_with_five_in_a_number
{
     ...
     * O(1).
     */
    public static int replace_three_with_five (int num)
    {
    ...
    public static void main (String[] args)
    {
         ...
         */
        assert(Integer.MAX_VALUE == replace_three_with_five(Integer.MAX_VALUE));

        /*
         * Test 8: Test with the minimum negative number -2147483648. The
         *         result should be minimum negative number itself
         */
        assert(Integer.MIN_VALUE == replace_three_with_five(Integer.MIN_VALUE));
    }
}
