...
public class check_if_binary_representation_of_number_is_palindrome
{
     ...
     * function is O(1).
     */
    public static boolean if_binary_representation_num_is_palindrome (int num)
    {
        int left, right;
        int left_val, right_val;
        int bit_size = BYTES_PER_INT * BITS_PER_BYTE; /* calculate the number
                                                         bits in the number */
    ...
    public static void main (String[] args)
    {
         ...
         */
        assert(true ==
                if_binary_representation_num_is_palindrome(0xffffffff));
        assert(true ==
                if_binary_representation_num_is_palindrome(0xe0e00707));
        assert(true ==
                if_binary_representation_num_is_palindrome(0x80800101));
        assert(true ==
                if_binary_representation_num_is_palindrome(0x10100808));
         ...
         */
        assert(false ==
                if_binary_representation_num_is_palindrome(0x0000ffff));
        assert(false ==
                if_binary_representation_num_is_palindrome(0x70700707));
    }
