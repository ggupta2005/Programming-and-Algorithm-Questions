 ...
 * is O(1).
 */
int linear_search_for_num (int* array, int len, int num)
{
    int index;
 ...
 * function is O(1).
 */
int binary_search_for_num (int* array, int len, int num)
{
    int mid, low, high;
...
int main ()
{
    ...
    int num0 = 7;
    int exp_index0 = 4;
    assert(exp_index0 == linear_search_for_num(array0, len0, num0));
    assert(exp_index0 == binary_search_for_num(array0, len0, num0));
    ...
    int num1 = 11;
    int exp_index1 = 8;
    assert(exp_index1 == linear_search_for_num(array1, len1, num1));
    assert(exp_index1 == binary_search_for_num(array1, len1, num1));
    ...
    int num2 = 1;
    int exp_index2 = 0;
    assert(exp_index2 == linear_search_for_num(array2, len2, num2));
    assert(exp_index2 == binary_search_for_num(array2, len2, num2));
    ...
    int num3 = array3[len3 - 1] + 1;
    int exp_index3 = ILLEGAL;
    assert(exp_index3 == linear_search_for_num(array3, len3, num3));
    assert(exp_index3 == binary_search_for_num(array3, len3, num3));
    ...
    assert(exp_index4 == linear_search_for_num(array4, len4, num4));
    assert(exp_index4 == binary_search_for_num(array4, len4, num4));
    ...
    assert(exp_index5 == linear_search_for_num(array5, len5, num5));
    assert(exp_index5 == binary_search_for_num(array5, len5, num5));
