...
public class reverse_bits_of_an_integer
{
    /*
     ...
     */
    public static int reverse_bits_v1 (int num)
    {
        int num_reverse;
        int index;
        int len_in_bits = 32; /* size of integer is 32 bits in java */
     ...
     */
    public static int reverse_bits_v2 (int num)
    {
        int num_copy = num;
