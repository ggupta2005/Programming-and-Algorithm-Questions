...
public class check_if_a_number_is_power_of_eight
{
    /*
     ...
     */
    public static boolean if_num_is_power_of_eight_v1 (int num)
    {
        int count_bits_set;
     ...
     * a number is a power of eight.
     */
    public static boolean if_num_is_power_of_eight_v2 (int num)
    {
        int count_bits_set;
