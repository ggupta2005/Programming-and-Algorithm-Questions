...
public class find_length_longest_palindromic_substring
{
    /*
     ...
     */
    public static int get_length_longest_palindromic_substring (String ch)
    {
        ...
        for (index = 0; index < len; ++index) {
            ...
            for (inner_index = 1;
                ...
                if (ch.charAt(index - inner_index)
                                         == ch.charAt(index + inner_index)) {

                    /*
                     * If the equi-distant characters around 'index' are
                     * equal, then increment the length of current
                     * palindromic sub-string by two
                     */
                    cur_len += 2;
                } else {
            ...
            /*
             * Find the length for the evem length palindromic string with
             * finding the matching character starting at 'index'.
             */
            cur_len = 0;
            for (inner_index = 1;
                 ...
                 */
                if (ch.charAt(index - (inner_index - 1)) ==
                                            ch.charAt(index + inner_index)) {
                    cur_len += 2;
                } else {
            ...
            /*
             * If the length of the even length palindromic substring is
             * greater than the current maximum length, then update the
             * maximum length
             */
            if (cur_len > max_len) {
                max_len = cur_len;
