 ...
 */
bool if_num_is_sparse_v1 (int num)
{
    int index;

    /*
     * Iterate through all the bits in the number and check if the
     * any of consecutive bits in the number are set.
     */
    for (index = 0; index < (sizeof(num) * CHAR_BIT - 1); ++index) {
 ...
 */
bool if_num_is_sparse_v2 (int num)
{
    /*
