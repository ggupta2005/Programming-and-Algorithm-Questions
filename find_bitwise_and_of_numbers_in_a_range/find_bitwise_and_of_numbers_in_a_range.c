 ...
 * O(1).
 */
int find_bitwise_and_numbers_in_range_v1 (int low, int high)
{
    int all_and, num;
 ...
 */
int find_bitwise_and_numbers_in_range_v2 (int low, int high)
{
     ...
     */
    for (bit = 0; bit < ((sizeof(int) * 8) - 1); ++bit) {
...
int main ()
{
     ...
     */
    int and5 = 0;
    assert(and5 == find_bitwise_and_numbers_in_range_v2(0, INT_MAX));
