 ...
 * NULL.
 */
struct treenode* get_predecessor_binary_search_tree (struct treenode* root,
                                                     int value)
{
    struct treenode* value_node = NULL;
    struct treenode* predecessor_node = NULL;
...
int main ()
{
    ...
    assert(NULL == get_predecessor_binary_search_tree(root0, 10));
    ...
    assert(NULL == get_predecessor_binary_search_tree(root1, 10));
    ...
    struct treenode* predecessor_node2 = NULL;
    ...
    predecessor_node2 = get_predecessor_binary_search_tree(root2, 190);
    assert((NULL != predecessor_node2) && (170 == predecessor_node2->data));
    predecessor_node2 = get_predecessor_binary_search_tree(root2, 40);
    assert(NULL == predecessor_node2);
    predecessor_node2 = get_predecessor_binary_search_tree(root2, 100);
    assert((NULL != predecessor_node2) && (90 == predecessor_node2->data));
    predecessor_node2 = get_predecessor_binary_search_tree(root2, 50);
    ...
    assert(NULL == get_predecessor_binary_search_tree(root3, 10));
